...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/universe/Documents/Code/OpenSource/rest-api-image-resizer/deps/osx --disable-doc --disable-programs --disable-everything --enable-demuxer=mov --enable-demuxer=matroska --enable-demuxer=aac --enable-demuxer=flac --enable-demuxer=mp3 --enable-demuxer=ogg --enable-demuxer=wav --enable-decoder=mpeg4 --enable-decoder=h264 --enable-decoder=vp9 --enable-decoder=vp8 --enable-decoder=flac --enable-decoder=mp3 --enable-decoder=aac --enable-decoder=vorbis --disable-iconv
prefix=/Users/universe/Documents/Code/OpenSource/rest-api-image-resizer/deps/osx
...
SRC_PATH=/Users/universe/Documents/Code/OpenSource/rest-api-image-resizer/deps/ffmpeg
SRC_LINK=src
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=Apple clang version 11.0.0 (clang-1100.0.33.8)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
ASMSTRIPFLAGS= -x
YASMFLAGS=-f macho64  -DPIC -DPREFIX
BUILDSUF=
PROGSSUF=
...
EXTRALIBS=-framework QuartzCore -framework CoreFoundation -framework VideoToolbox -framework CoreMedia -framework CoreVideo -framework CoreFoundation -framework AudioToolbox -framework CoreMedia -framework VideoDecodeAcceleration -framework CoreFoundation -framework QuartzCore -Wl,-framework,CoreFoundation -Wl,-framework,Security -lm -llzma -lbz2 -lz -pthread -framework CoreServices 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
